...
) 
{
    ...
    //
    if(Transform3DNoiseCoordinates > 0.0001)
    {
...
void main()
{
	...
	BumpVertexOutput OUT = BumpVS( IN, WorldITXf, WorldXf, ViewIXf, WvpXf,
	WvXf,
	Lamp0Pos, Lamp1Pos, NormMapScale, FadeDistance );

	frontColor = OUT.Color;
	ModelUV = OUT.ModelUV;
