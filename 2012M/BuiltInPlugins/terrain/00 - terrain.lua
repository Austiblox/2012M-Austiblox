...
local toolbarbutton = toolbar:CreateButton("", "Terrain Generator", "terrain.png")
...
function ClearTerrain()
	...
	z = zMax
	while z >= zMin do
		-- Progress bar was told to cancel, end.
		if cancelValues.cancelActions then
			game:GetService("ChangeHistoryService"): SetWaypoint("CancelClear")
			UnloadProgressBar()
			return
		end
		...
		cancelValues.setAmountFunc(rprogress)
...
widthSliderGui, widthSliderPosition = CreateStandardSlider('WidthSliderGui', UDim2.new(0,1,0,108), UDim2.new(0,10,0.5,-2), 4, 
...
widthSliderPosition.Value = math.pow(2, widthSliderPosition.Value + 5)
...
lengthSliderGui, lengthSliderPosition = CreateStandardSlider('LengthSliderGui', UDim2.new(0,1,0,149), UDim2.new(0,10,0.5,-2), 4, 
...
lengthSliderPosition.Value = math.pow(2, lengthSliderPosition.Value + 5)
...
baseHeightSliderGui, baseHeightSliderPosition = CreateStandardSlider('BaseHeightSliderGui', UDim2.new(0,1,0,272), UDim2.new(0,10,0.5,-2), game.Workspace.Terrain.MaxExtents.Max.Y, 
...
waterHeightSliderGui, waterHeightSliderPosition = CreateStandardSlider('WaterHeightSliderGui', UDim2.new(0,1,0,313), UDim2.new(0,10,0.5,-2), game.Workspace.Terrain.MaxExtents.Max.Y, 
